...
public abstract class AbstractIntegrationTest {
    ...
    private static final String DEFAULT_KAFKA_TAG = "7.4.0";
    private static final DockerImageName KAFKA_IMAGE_NAME = 
        DockerImageName.parse("confluentinc/cp-kafka").withTag(DEFAULT_KAFKA_TAG);
    ...
    private void setupTopics() throws ExecutionException, InterruptedException {
        log.info("Creating test topics");
        
        List<NewTopic> topics = List.of(
            new NewTopic(TEST_TOPIC_NAME, 1, (short) 1),
            new NewTopic(SINK_TOPIC_NAME, 1, (short) 1),
            new NewTopic(SOURCE_TOPIC_NAME, 1, (short) 1)
        );
